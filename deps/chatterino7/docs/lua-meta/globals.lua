...
c2.EventType = {
    ...
    EmptyInputBackspace = {}, ---@type c2.EventType.EmptyInputBackspace
}
...
c2.ChannelType = {
    ...
    Rumble = {}, ---@type c2.ChannelType.Rumble
}
...
-- Begin src/controllers/plugins/PluginControlTab.hpp
...
c2.ui = {}
---@class c2.PluginControlTabHandle
c2.PluginControlTabHandle = {}

--- Atomically replaces the collapsed summary. Invalid updates preserve the last valid state.
---
---@param summary c2.PluginControlTabSummary
function c2.PluginControlTabHandle:update_summary(summary) end

--- Atomically updates authoritative state for the named controls.
---
---@param controls c2.PluginControlStateUpdate[]
function c2.PluginControlTabHandle:update_controls(controls) end

--- Shows or hides this plugin generation's contribution.
---
---@param visible boolean
function c2.PluginControlTabHandle:set_visible(visible) end

--- Removes this contribution and permanently invalidates the handle.
---
function c2.PluginControlTabHandle:remove() end

---@return boolean valid
function c2.PluginControlTabHandle:is_valid() end

--- Registers one bounded top control tab for this plugin generation.
--- Requires the `UiControlTabs` permission.
---
---@param descriptor c2.PluginControlTabDescriptor
---@return c2.PluginControlTabHandle handle
function c2.ui.register_control_tab(descriptor) end

-- End src/controllers/plugins/PluginControlTab.hpp
