...
public:
    ...
    bool hasPermission(PluginPermission::Type type) const;

    std::shared_ptr<lua::api::PluginControlTabRegistration> controlTab() const;
    void setControlTab(
        std::shared_ptr<lua::api::PluginControlTabRegistration> registration);
    void removeControlTab(
...
private:
    ...
    std::shared_ptr<lua::api::PluginControlTabRegistration> controlTab_;
