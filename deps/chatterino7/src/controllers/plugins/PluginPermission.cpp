...
QString PluginPermission::toHtml() const
{
    switch (this->type)
    {
        ...
        case PluginPermission::Type::UiControlTabs:
            return "Add one bounded control tab to the top of Chatterino "
                   "windows and receive interactions with its declared controls";
        default:
