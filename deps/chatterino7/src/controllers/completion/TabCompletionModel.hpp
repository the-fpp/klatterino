...
public:
    ...
    void updateResults(const QString &query, const MessageDraft &draft,
                       int cursorPosition, bool isFirstWord = false);

    Selection selectionForRow(int row) const;
    Selection selectionForCompletion(const QString &completion) const;
