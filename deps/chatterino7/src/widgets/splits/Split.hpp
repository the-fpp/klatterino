...
public:
    ...
    /// Canonical public locator for a selected top-level or nested Rumble
    /// channel. Runtime channel names are deliberately never consulted.
    std::optional<QString> getSelectedLocator() const;
