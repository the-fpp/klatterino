          ...
          parent)
{
    ...
    this->ui_.rumbleAccountSwitcher = new RumbleAccountSwitchWidget(this);
    this->ui_.rumbleAccountSwitcher->setFocusPolicy(Qt::NoFocus);

    notebook->addPage(this->ui_.accountSwitchWidget, "Twitch");
    notebook->addPage(this->ui_.kickAccountSwitcher, "Kick");
    notebook->addPage(this->ui_.rumbleAccountSwitcher, "Rumble");
...
void AccountSwitchPopup::refresh()
{
    ...
    this->ui_.rumbleAccountSwitcher->refresh();
}
