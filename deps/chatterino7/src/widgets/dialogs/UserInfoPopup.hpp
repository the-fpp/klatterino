...
public:
    ...
    void setData(const UserCardIdentity &identity,
...
private:
    void installEvents();
    void updateUserData();
    void updateRumbleUserData();
    void updateLatestMessages();
    void updateNotes();
    void applySurfacePolicy();
    bool isCurrentRequest(const UserCardIdentityKey &key,
    ...
    void loadSevenTVAvatar(const QString &userID, bool isKick,
                           const UserCardIdentityKey &key, uint64_t generation);
    ...
    UserCardIdentity identity_;
    uint64_t identityGeneration_ = 0;
    ...
    struct {
        ...
        PixmapButton *platformBadge = nullptr;
        Label *platformLabel = nullptr;
        Label *rumbleMetadataLabel = nullptr;
        ...
        PixmapButton *mod = nullptr;
        PixmapButton *unmod = nullptr;
        PixmapButton *vip = nullptr;
        PixmapButton *unvip = nullptr;
        Line *moderationLine = nullptr;
        Line *afterModerationLine = nullptr;
