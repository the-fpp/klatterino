...
public:
    ...
    /// Uses the theme's semantic tab-live color for this label and its mouse
    /// effects, updating automatically when the theme changes.
    void useTabLiveIndicatorColor();
...
private:
    ...
    QLabel label_;
    QSize padding_;
    bool tabLiveIndicatorColor_ = false;
};
