...
EmotePtr getRumbleBadge()
{
    static EmotePtr ptr = std::make_shared<const Emote>(Emote{
        ...
        .images =
            ImageSet{
                Image::fromUrl(
                    {platformBadgeResource(MessagePlatform::Rumble, false)
                         .toString()},
                    1.0, {18, 18}),
                Image::fromUrl(
                    {platformBadgeResource(MessagePlatform::Rumble, true)
                         .toString()},
                    .5, {36, 36}),
            },
        .tooltip = Tooltip{},
...
EmotePtr getPlatformBadge(MessagePlatform platform)
{
    switch (platform)
    {
        case MessagePlatform::AnyOrTwitch:
            return getTwitchBadge();
        case MessagePlatform::Kick:
            return getKickBadge();
        case MessagePlatform::Rumble:
            return getRumbleBadge();
    }
    return nullptr;
}
...
QStringView platformBadgeResource(MessagePlatform platform,
                                  bool highResolution)
{
    switch (platform)
    {
        case MessagePlatform::AnyOrTwitch:
            return highResolution
                       ? u":/badges/platform-twitch-36.webp"
                       : u":/badges/platform-twitch-18.webp";
        case MessagePlatform::Kick:
            return highResolution ? u":/badges/platform-kick-36.webp"
                                  : u":/badges/platform-kick-18.webp";
        case MessagePlatform::Rumble:
            return highResolution
                       ? u":/badges/platform-rumble-36.webp"
                       : u":/badges/platform-rumble-18.webp";
    }
    return {};
}
                                 ...
                                 const MessageLayoutContext &ctx)
{
        ...
        ctx.selectedChannel != nullptr)
    {
        ...
        {
            emote = getPlatformBadge(ctx.message.platform);
        }
