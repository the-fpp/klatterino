...
struct RumbleMessageMetadata {
    QString channelID;
    QStringList badgeIDs;
    QStringList roleIDs;
    QString source;

    friend bool operator==(const RumbleMessageMetadata &,
                           const RumbleMessageMetadata &) = default;
};
...
struct Message {
    ...
    std::optional<RumbleMessageMetadata> rumble;
