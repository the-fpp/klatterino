...
/// Returns the packaged indicator resource for a platform and scale.
...
enum class MessageElementFlag : int64_t {
    ...
    /// `Username` but the username comes from Rumble. Rumble identities must
    /// not inherit Twitch/7TV username paints that happen to share a login.
    RumbleUsername = (1LL << 53),
