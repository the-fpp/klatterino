...
QJsonObject Message::toJson() const
{
    ...
    if (this->rumble)
    {
        msg["rumble"_L1] = QJsonObject{
            {"channelID"_L1, this->rumble->channelID},
            {"badgeIDs"_L1,
             QJsonArray::fromStringList(this->rumble->badgeIDs)},
            {"roleIDs"_L1,
             QJsonArray::fromStringList(this->rumble->roleIDs)},
            {"source"_L1, this->rumble->source},
        };
    }
